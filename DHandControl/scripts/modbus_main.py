...
class DexHandControl:
    ...
    def clear_finger_error(self, finger_id):
        return self.clear_error(dev_id=finger_id, dev_type=0)
    
    def clear_palm_error(self, palm_id):
        return self.clear_error(dev_id=palm_id, dev_type=1)
